                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-offset-4 col-md-offset-4 col-lg-offset-4 col-sm-5 col-md-5 col-lg-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="tax" name="tax" value="14.5" placeholder="Tax" onkeyup="calculateTotal()" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
                                                    <div class="input-group-addon">%</div>
                                                </div>
                                            </div>
                                            <div class="form-group">
