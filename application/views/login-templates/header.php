...
<html lang="en">
    <head>
        ...
        <!-- Optional CSS Files -->
        <link type="text/css" href="<?php echo base_url(); ?>css/optional/bootstrapValidator.min.css" rel="stylesheet" />
        <!-- add CSS files here -->
        ...
        <!-- Demo CSS Files -->
        <link type="text/css" href="<?php echo base_url(); ?>css/demo-files/pages-signin-signup.css" rel="stylesheet" />
